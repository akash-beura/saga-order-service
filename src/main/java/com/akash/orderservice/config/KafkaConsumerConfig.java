...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PaymentCompletionEvent> paymentCompletedKafkaListenerContainerFactory
            () {
        return kafkaListenerContainerFactory(PaymentCompletionEvent.class);
    }
